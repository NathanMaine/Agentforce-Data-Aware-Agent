...
## [0.4.0](https://github.com/NathanMaine/Agentforce-Data-Aware-Agent/compare/v0.3.0...v0.4.0) (2025-12-15)


### Features

* add automatic routing in Planner.cls for inventory/stock/reserve goals ([2d14355](https://github.com/NathanMaine/Agentforce-Data-Aware-Agent/commit/2d14355a1f1fad1dc84b8b695395d40711e65d46))
* add checkpoint guard for input validation before database operations ([0b6a4fa](https://github.com/NathanMaine/Agentforce-Data-Aware-Agent/commit/0b6a4faa7d755067b66bd0b9b8b0c8e116a82815))
* implement automated release management ([60bea64](https://github.com/NathanMaine/Agentforce-Data-Aware-Agent/commit/60bea6498356da8eab43099703c51c8f2b52461e))
